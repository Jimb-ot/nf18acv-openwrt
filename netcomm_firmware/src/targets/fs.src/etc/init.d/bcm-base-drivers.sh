...
#load usb modules
 ...
 test -e /lib/modules/privat_module/cdc-wdm.ko && insmod /lib/modules/privat_module/cdc-wdm.ko
 test -e /lib/modules/privat_module/qmi_wwan.ko && insmod /lib/modules/privat_module/qmi_wwan.ko
 test -e /lib/modules/privat_module/cdc_ncm.ko && insmod /lib/modules/privat_module/cdc_ncm.ko
# test -e /lib/modules/privat_module/fg_ether.ko && insmod /lib/modules/privat_module/fg_ether.ko
# test -e /lib/modules/privat_module/GobiNet.ko && insmod /lib/modules/privat_module/GobiNet.ko
 test -e /lib/modules/$KERNELVER/kernel/drivers/net/usb/cdc_ncm.ko && insmod /lib/modules/$KERNELVER/kernel/drivers/net/usb/cdc_ncm.ko
 ...
 test -e /lib/modules/$KERNELVER/kernel/drivers/usb/serial/usb_wwan.ko && insmod /lib/modules/$KERNELVER/kernel/drivers/usb/serial/usb_wwan.ko
 ...
 test -e /lib/modules/privat_module/user_usb_modem.ko && insmod /lib/modules/privat_module/user_usb_modem.ko
...
#vtp init
 test -e /etc/rc_vtp2.0 && /etc/rc_vtp2.0
